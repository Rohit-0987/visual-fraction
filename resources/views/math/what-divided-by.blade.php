...
<body>
    ...
    <div class="manual-container w-full mt-md-5 mt-3">
        <div class="row">
            <h1 class="col-12 ">What Divided by Equals Calculator</h1>
        ...
        <div class="row mt-4">
            ...
            <p>I mean, do we really need to explain how this calculator works? You enter the whole number in the left hand box, then answer in the right hand boxe, you click "Calculate" and hey presto, we calculate the missing number for you.</p>
        </div>
        <div class="row mt-5">
            <div class="col-12">
                <h2 class="">Preset List of What Divided by Equals</h2>
            </div>
            <div class="col-12">
        ...
        <div class="row">
            @for ($num1 = 1; $num1 <= 99; $num1++)
                @for ($num2 = 1; $num2 <= 100; $num2++)
                    ...
                    <a href="/what-divided-by/what-divided-by-{{$num1}}-equals-{{$num2}}"
                        class="col-md-4 col-sm-6 col-12 text-center my-2">
                        What divided by {{$num1}} equals {{$num2}}
                    </a>
                @endfor
            @endfor
        </div>
