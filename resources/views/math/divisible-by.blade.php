...
<body>
    ...
    <div class="manual-container w-full mt-md-5 mt-3">
        <div class="row">
            <h1 class="col-12 ">Divisible by X Calculator</h1>
            <p class="col-12 fs-5">A quick and easy calculator to check if one number is divisible by another.</p>
        </div>
        <div class="row">
        ...
        <div class="row mt-4">
            ...
            <p>I mean, do we really need to explain how this calculator works? You enter the whole number in the first box, then the number you want to check it is divisible by in the second box, you click "Calculate" and hey presto, we calculate the divisibility.</p>
        </div>
        <div class="row mt-5">
            <div class="col-12">
            ...
            @for($num1 = 2; $num1 <= 99; $num1++)
                @for($num2 = 3; $num2 <= 100; $num2++)
                    @if($num1 >= $num2)
                        @continue
                    @endif
                            <a href="divisible-by/is-{{$num1}}-divisible-by-{{$num2}}" class="col-md-4 col-sm-6 col-12 text-center my-2">
                                 is {{$num1}} divisibe by {{$num2}} ?
                            </a>
                @endfor
            @endfor
        </div>
