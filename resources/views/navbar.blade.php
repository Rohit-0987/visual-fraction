...
{{-- <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background: linear-gradient(to right, rgba(127,148,240,0.9), rgba(181,113,249,1))"> --}}
<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background: linear-gradient(to right, rgba(106,17,203,1), rgba(37,117,252,1))">
<div class="container">
	<a class="navbar-brand" href="/">Envobiz</a>
	<button class="navbar-toggler aa"  type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	...
	<ul class="navbar-nav me-auto mb-2 mb-lg-0">
		...
		<ul class="dropdown-menu" id="1" style="background:rgba(37,117,252,1)">
			<li><a class="dropdown-item text-light" href="{{url('add-fractions')}}">Add Fractions</a></li>
			<li><a class="dropdown-item text-light" href="">Subtract Fractions</a></li>
			<li><a class="dropdown-item text-light" href="">Divide Fractions</a></li>
		...
		<ul class="dropdown-menu" id="2" style="background:rgba(37,117,252,1)">
		...
		<li class="nav-item">
		<a class="nav-link" aria-current="page" href="#">Unit Converter</a>
		</li>
	</ul>
